...
class KeyboardHabitatRoamer:
    ...
    def __init__(
        ...
        :param launch_file_path: path to the launch file which launches the
            keyboard teleop node and some other nodes for control and visualization
        ...
        """
        # create a node
        rospy.init_node("keyboard_habitat_roamer", anonymous=True)
