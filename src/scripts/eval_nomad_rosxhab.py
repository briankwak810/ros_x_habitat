...
from src.evaluators.nomad_rosxhab_evaluator import NomadHabitatROSEvaluator
...
def main():
    ...
    parser.add_argument(
        "--task-config", type=str, default="configs/setting_5_configs/pointnav_rgbd-mp3d_with_physics.yaml"
    )
    ...
    if "PHYSICS_SIMULATOR" in exp_config:
        ...
        evaluator = NomadHabitatROSEvaluator(
            config_paths=args.task_config,
            input_type=args.input_type,
            # model_path=args.model_path,
            launch_file_path="../visualnav-transformer/deployment/launch/vint_keyboard.launch",
            enable_physics=True,
